const API_CONFIG = {
  JOBS_APIS: [
    ...
    { name: 'Remotive Remote Jobs', url: import.meta.env.VITE_JOBS_API_5_URL || 'https://remotive.com/api/remote-jobs', apiKey: import.meta.env.VITE_JOBS_API_5_KEY || '', enabled: true, type: 'api' },
    { name: 'Jobicy Remote Jobs', url: import.meta.env.VITE_JOBS_API_3_URL || 'https://jobicy.com/api/v2/remote-jobs', apiKey: import.meta.env.VITE_JOBS_API_3_KEY || '', enabled: true, type: 'api' },
    { name: 'Himalayas Remote Jobs', url: import.meta.env.VITE_JOBS_API_4_URL || 'https://himalayas.app/jobs/api', apiKey: import.meta.env.VITE_JOBS_API_4_KEY || '', enabled: true, type: 'api' },
    { name: 'Arbeitnow Job Board', url: import.meta.env.VITE_JOBS_API_6_URL || 'https://www.arbeitnow.com/api/job-board-api', apiKey: import.meta.env.VITE_JOBS_API_6_KEY || '', enabled: true, type: 'api' },
    { name: 'Junta Castilla y León Empleo', url: import.meta.env.VITE_JOBS_API_1_URL || 'https://data.opendatasoft.com/api/records/1.0/search/?dataset=ofertas-de-empleo@jcyl', apiKey: import.meta.env.VITE_JOBS_API_1_KEY || '', enabled: true, type: 'api' },
  ...
  COURSES_APIS: [
    ...
    { name: 'Khan Academy', url: import.meta.env.VITE_COURSES_API_1_URL || 'https://www.khanacademy.org/api/v1/topic/root', apiKey: import.meta.env.VITE_COURSES_API_1_KEY || '', enabled: false, type: 'api' },
